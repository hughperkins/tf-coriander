...
struct Options {
  ...
  int num_iterations = 1;          // Each step repeats this many times
...
GraphDef CreateGraphDef() {
  ...
  // x = [1.0 4; 1.0 2]
  auto x = Const(root.WithOpName("x"), {{1.f, 4.0f}, {1.f, 2.0f}});

  // y = a + x
  auto y = Add(root.WithOpName("y"), a, x);
