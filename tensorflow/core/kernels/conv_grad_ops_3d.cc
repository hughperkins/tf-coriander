 ...
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    Eigen::array<Eigen::IndexPair<Eigen::DenseIndex>, 5> pad_dims{
        {0, 0},
        {(IndexType)top_pad_planes, (IndexType)bottom_pad_planes},
        {(IndexType)top_pad_rows, (IndexType)bottom_pad_rows},
        {(IndexType)left_pad_cols, (IndexType)right_pad_cols},
        {0, 0}};
    Tensor* in_backprop;
    ...
    Eigen::DSizes<Eigen::DenseIndex, 5> eigen_strides{1, (IndexType)strides[0], (IndexType)strides[1],
                                                      (IndexType)strides[2], 1};
